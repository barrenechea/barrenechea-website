...
import ProjectImage from "@/assets/images/project-ades-wii-x360.png";
...
export const title = "I hacked hundreds of game consoles thanks to a juice";
export const ogOverride = "Of game consoles thanks to a juice - I hacked hundreds"
export const description ="What I did instead of partying while young 🥴";
export const pubDate = new Date("2022-08-23T23:13:00Z");
export const link = "#";
export const imgSrc = ProjectImage;
export const imgAlt = "Composition of Bill Gates playing Guitar Hero on Mordor after being pwned by AdeS juice";
export const tags = [];

export default function Layout({ children }) {
  return <BasePost title={title} description={description} ogOverride={ogOverride} imgSrc={imgSrc} imgAlt={imgAlt} pubDate={pubDate}>{children}</BasePost>;
}
...
<Image src={Puzzle} alt="two pictures of puzzles side by side, the solution on the left and a scrambled version on the right" format="webp" />
...
<Image src={PuzzleNumbered} alt="two pictures of puzzles side by side, the solution on the left and a scrambled version on the right, with numbers overlay" format="webp" />
...
<Image src={X360PowerSupply} alt="picture of a custom power supply for Xbox 360 DVD drives" format="webp" />
...
<Image src={KamikazeLocation} alt="picture of a chip" format="webp" />
...
<Image src={WinbondExploitLines} alt="picture of a decapped chip" format="webp" />
...
<Image src={X360Linux} alt="picture of an Xbox 360 running Linux" format="webp" />
