...
After playing with the <a href="/es/projects/fl3xbl0w/decompiling" target="_self">decompiled apps</a> I can certainly say that the following documentation could be extrapolated in one way or another to the following Bowflex devices:
...
- <a href="/es/projects/fl3xbl0w/jailbreak" target="_self">Jailbreak de Android</a>
- <a href="/es/projects/fl3xbl0w/backup" target="_self">Respaldar los contenidos de tu Consola</a>
- <a href="/es/projects/fl3xbl0w/decompiling" target="_self">Decompilando</a>
- <a href="/es/projects/fl3xbl0w/quirks" target="_self">Curiosidades de Bowflex</a>

### Work in progress

- <a href="/es/projects/fl3xbl0w/treadmotor" target="_self">Controlador del Motor de la Trotadora</a>
- <a href="/es/projects/fl3xbl0w/romdump" target="_self">Dump de la ROM</a>
