...
Este fue bastante fácil de descifrar. El nombre Bluetooth aparece como `CL831-xxxxxxx` *(número oculto)* de [CHILEAF](https://www.chileaf.com/copy-cl830-health-monitor-armband-heart-rate-monitor-product/).
...
<Image src={HomeAssistantSensor} alt="Captura de pantalla de HomeAssistant mostrando un sensor de ritmo cardíaco" format="webp" />
