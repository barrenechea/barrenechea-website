...
Vantron is the basis for most of Nautilus Inc.'s "smart devices". Basically, an Android tablet running proprietary software. In addition to some hardware-related things that piqued my curiosity.
...
Nautilus, Inc. only offers a 1-year warranty on the electronic parts, and as soon as I saw that the mechanism to turn off the machine (and therefore, the Android tablet) was basically "cut the AC power through the rear switch", that scared me. Every Linux-based device should be shut down safely to prevent operating system corruption, and this Android tablet is no exception. So as long as it's running, why not have a little more fun with it?
