...
I've used a Logitech K600, but any keyboard with such keys should work:

<Image src={LogiKeys} alt="Logitech K600 Keyboard" format="webp" />

_Bluetooth keyboards seem not to be able to be paired through JRNY._
...
_It will ask you for an in-screen confirmation the first time you remotely connect through adb._
...
_(the typos you may see on the code dumps are coming from the Nautilus' developers themselves, not me)_
