---
title: Backing Up Your Console's Contents - fl3xbl0w
...
You will see records of applications from `com.nautilus`, `com.redbend`, `com.netflix`, `com.amazon`, `com.disney`, and perhaps some more in the future. We will want to back up everything we see on that list (unique IDs hidden, use your own results):
...
I developed a quick and dirty Python script to back up some content (it does not include AppData for now).
...
# filter lines containing "com.android", "com.google", "framework-res"
