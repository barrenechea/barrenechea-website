...
This assumes that you already [have your own APKs](/en/projects/fl3xbl0w/backup). Keep in mind that, although I am specifying this for Nautilus apps, this applies to virtually any Android app you want to "take a look under the hood".
