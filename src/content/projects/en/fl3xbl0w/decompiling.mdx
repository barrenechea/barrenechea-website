...
The community has tested [this](https://www.reddit.com/r/Bowflex/comments/mi8wdo/unlocking_bowflex_velocore/) to apply some patches to our APKs. It would only work for non-system apps, as without the proper signing key, the app will not have access to system resources (such as the Serial port).
