...
_`DOMAIN_PIN` looks like an actual pin code since it is a six-digit number._
...
This one was pretty easy to figure out. The Bluetooth name appears as `CL831-xxxxxxx` _(hidden number)_ from [CHILEAF](https://www.chileaf.com/copy-cl830-health-monitor-armband-heart-rate-monitor-product/).
...
<Image
  ...
  alt="HomeAssistant screenshot displaying a heart rate sensor"
  format="webp"
/>
