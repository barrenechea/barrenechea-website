...
Á síðustu vikum, og um það bil tví árin eftir að ég hóf þetta, hafa nokkrir tengst mér til að spyrja um framvindu þessa, sem staðfestir upphaflega ráðstock mín að bandvélskerfið væri hrikalegt og það var aðeins mál tíma áður en tæki hefðu byrjað að bilast. Það virtist vera góður tími til að nýta logic analyzer mína, sem þar til nú hafði aðeins verið að safna ryki.
