---
title: fl3xbl0w
description: Progetto di ingegneria inversa. Iniziato con il tapis roulant Bowflex Treadmill 22 ma poi generalizzato per qualsiasi macchina con Android venduta da Nautilus Inc. (Nautilus, Bowflex, Schwinn).
...
Mi sono basato molto su un lavoro precedente che ho trovato su [Reddit](https://www.reddit.com/r/Bowflex/comments/mi8wdo/unlocking_bowflex_velocore/) (grazie [xasmx](https://www.reddit.com/user/xasmx/)!) per ottenere una comprensione più profonda del software e dell'hardware della macchina.

## Dispositivi compatibili (Jailbreak di Android)

Dopo aver giocato con le <a href="/it/projects/fl3xbl0w/decompiling" target="_self">applicazioni decompilate</a>, posso dire con certezza che la seguente documentazione potrebbe essere estrapolata in un modo o nell'altro ai seguenti dispositivi Bowflex:
...
- <a href="/it/projects/fl3xbl0w/treadmotor" target="_self">
    Controllore del Motore del Tapis Roulant
  </a>
