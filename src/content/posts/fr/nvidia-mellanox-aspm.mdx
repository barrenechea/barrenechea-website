...
imgAlt: "Généré via Midjourney avec le texte : Centre de données Nvidia vert à l'intérieur d'une biosphère en verre émettant un gaz gris, impactant, coloré, réaliste, objectif Canon, haute détail --v 4 --ar 3:2"
