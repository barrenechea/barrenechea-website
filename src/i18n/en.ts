...
export const en: OptionalTranslations = {
  ...
  'hero.currentTeam': 'as Technical Manager ',
  'hero.lookingFor': 'I am currently looking for new job opportunities',
  'hero.noEmployment': 'I am currently not employed',
  ...
  'posts.paginationDescription':
    'Result of some brain-dumping processes that I go through from time to time',
  'posts.by': 'By',
  'posts.on': 'on',
  ...
  'projects.paginationDescription':
    "Not necessarily everything I've done, but what I'm legally allowed to share 😄",
...
export const enWithFallback: { [Key in keyof typeof es]: string } = new Proxy(en, {
